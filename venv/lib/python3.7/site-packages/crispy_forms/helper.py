...
class FormHelper(DynamicLayoutHandler):
    ...
    Let's see what attributes you can set and what form behaviors they apply to:
        ...
        **include_media**: Whether to automatically include form pictures. Set to False if
            you want to manually include form pictures outside the form. Defaults to True.
