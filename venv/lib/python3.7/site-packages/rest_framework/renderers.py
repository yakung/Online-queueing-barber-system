"""
Renderers are used to serialize a response into specific pictures types.

They give us a generic way of being able to handle various pictures types
...
class JSONRenderer(BaseRenderer):
    ...
    def get_indent(self, accepted_media_type, renderer_context):
        if accepted_media_type:
            # If the pictures type looks like 'application/json; indent=4',
